...
@implementation HTGetOrderInfoView
...
//    jgLabel = [[UILabel alloc]  initWithFrame:CGRectMake(120, CGRectGetMaxY(lockType.frame), CGRectGetWidth(lockType.frame), CGRectGetHeight(applyer.frame))];
//    //    jgLabel.text = @"5分钟前发布";
